package com.example.task12_2_bonus;
...
//        // myDBHelper 인스턴스 생성 > 이 때 myDBHelper()의 생성자가 실행 되면서 groupDB 파일이 생성된다.
    ...
    public class myDBHelper extends SQLiteOpenHelper{
        ...
        public myDBHelper(Context context) {
            super(context, "task12_3.db", null, 1);
        ...
        public void onOpen(SQLiteDatabase db) {
            ...
            // assets 폴더에 있는 데이터베이스 파일 열기
            try {

                InputStream inputStream = context.getAssets().open("task12_3.db");
